...
public class Private_button extends Button{



    public Private_button(qq mi, String user, String name , boolean pd){
        mi.remove(mi.JPfriend);//移除之前的界面,现在肯定在好友界面????大哥不一定啊，也有可能是会话界面
...
//        HeadPortrait.Cyh(System.getProperty("user.dir")+"/Server_data/User Avatar/Tailoring/321.jpg",a,new ImageIcon(),40,40);
        ...
        new Private_chat(mi,user,name,pd);//创建右侧输入框之类的
        ...
        a.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                //然后重新加载新的组件
                mi.JPconfu.add(mi.Sessionrw.get(user).all);
